...
pub fn is_nice(good_deeds: u32, bad_deeds: u32) -> bool {
    ...
    if good_deeds == 0 && bad_deeds == 0 {
      false  
        ...
        (good_deeds_f * GOOD_WEIGHT) / ((good_deeds_f * GOOD_WEIGHT) + (BAD_WEIGHT * bad_deeds_f)) >= 0.75
    } 
}
...
fn main() {
    ...
    if is_nice(good_deeds, bad_deeds) {
        println!("Santa will be visiting you this year!");
    } else {
        println!("You will be getting coal this year!");
    }
}
